...
const corsOptions = {
  origin: [
    'http://localhost:5173',
    'https://main--dazzling-bunny-af204e.netlify.app/',
    '*'
  ],
  credentials: true,
...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'http://localhost:5173','https://main--dazzling-bunny-af204e.netlify.app/', '*'); // Replace with your frontend origin
